...
<c:if test="${searchPageData.pagination.totalNumberOfResults == 0 && top && showTotals}">
    <div class="paginationBar top clearfix">
        <div class="totalResults"><spring:theme code="${themeMsgKey}.totalResults" arguments="${searchPageData.pagination.totalNumberOfResults}"/>
        </div>
    </div>
</c:if>
<c:if test="${searchPageData.pagination.totalNumberOfResults > 0}">
    <div class="pagination-bar ${(top)?"top":"bottom"}">
        ...
        <div class="pagination-prod-tool">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-6">
                            <div class="form-group">
                                ...
                                <form id="sortForm${top ? '1' : '2'}" name="sortForm${top ? '1' : '2'}" method="get"
                                      action="#">
                                    <select id="sortOptions${top ? '1' : '2'}" name="sort" class="form-control syncsort">
								    ...
								    <ul class="nav nav-tabs" id="myTab">
                                        <li class="active">
                                            <a class="btn-grid glyphicon glyphicon-th-large" name="show_grid"></a>
                                        </li>
                                        <li>
                                            <a class="btn-grid glyphicon glyphicon-th-list" name="show_list" ></a>
                                        </li>
                                   </ul>
