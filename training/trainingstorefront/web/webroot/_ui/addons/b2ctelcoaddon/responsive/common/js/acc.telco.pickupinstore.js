ACC.pickupinstore = {
		...
		createListItemHtml: function (data,id){
			...
			var $rdioEl = $("<input>").attr("type","radio")
				...
				.attr("id","pickup-entry-" + String(id))
			...
			var $spanElStInfo = $("<span>")
				...
				.append($("<span>").addClass("pickup-store-list-entry-name").text(String(data.displayName)))
				.append($("<span>").addClass("pickup-store-list-entry-address").text(String(data.line1) + " " + String(data.line2)))
				.append($("<span>").addClass("pickup-store-list-entry-city").text(String(data.town)));
